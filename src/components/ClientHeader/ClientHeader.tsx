...
import { TSBDLogo } from 'components';
import {
  Alarm,
  Award,
  Bell,
          ...
          <Group position="apart" mb="md">
            <Group spacing={theme.spacing.xs / 2}>
              <Popover
                ...
                target={(
                  <Button onClick={() => setOpenedCategoryMenu((o) => !o)} leftIcon={<List size={16}/>} radius="md"  color='green' variant="light">
                    Danh mục sản phẩm
                  </Button>
                )}
              ...
              <Button variant="subtle" color="green" radius="md" component={Link} to="/">
                Sản phẩm xu hướng
              </Button>
              <Button variant="subtle" color="pink" radius="md" component={Link} to="/">
                Khuyến mại
              </Button>
            </Group>
            <Group spacing="xs">
